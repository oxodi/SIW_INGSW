...
public class DammiAzienda extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		else if(btnCerca.equals("cercaAzienda")) {
			
			String inputCerca = req.getParameter("inputCerca");
			System.out.println("InputCerca:  "+inputCerca);
			aziendeDuplicate.add(aziendaDao.cercaPerNome(inputCerca));
		}
